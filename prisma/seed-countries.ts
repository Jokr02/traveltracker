...
/** Befüllt/aktualisiert die Country-Referenztabelle aus `world-countries`.
 * Reine Referenzdaten (keine Nutzerdaten) — für echte und Demo-DB identisch
 * nutzbar. */
export async function seedCountries(db: PrismaClient): Promise<number> {
